...
public class TagList 
{
    ...
    public TagList()
    {
...

        {
            ...
            tag_list[(int)VarRef.Tag.GenWoman].tier3.Add(VarRef.Topic.SportsGymnastics);

            tag_list[(int)VarRef.Tag.GenWoman].tier2.Add(VarRef.Topic.ClothesWomen);
        }

        {
            ...
            tag_list[(int)VarRef.Tag.GenMan].tier3.Add(VarRef.Topic.SportsGolf);
            ...
            tag_list[(int)VarRef.Tag.GenMan].tier2.Add(VarRef.Topic.ClothesMen);
        }

        {
            ...
            tag_list[(int)VarRef.Tag.AgeChild].tier2.Add(VarRef.Topic.ElecGames);
            tag_list[(int)VarRef.Tag.AgeChild].tier2.Add(VarRef.Topic.SportsGymnastics);
            tag_list[(int)VarRef.Tag.AgeChild].tier2.Add(VarRef.Topic.SportsFootball);
            tag_list[(int)VarRef.Tag.AgeChild].tier2.Add(VarRef.Topic.ClothesCostume);
        }
...

        {
            ...
            tag_list[(int)VarRef.Tag.AgeElderly].tier3.Add(VarRef.Topic.TravelCruise);
            ...
            tag_list[(int)VarRef.Tag.AgeElderly].tier2.Add(VarRef.Topic.FoodCafe);
            tag_list[(int)VarRef.Tag.AgeElderly].tier2.Add(VarRef.Topic.SportsGolf);
        }

        {
            ...
            tag_list[(int)VarRef.Tag.LiveCity].tier3.Add(VarRef.Topic.SportsGymnastics);
        }

        {
            ...
            tag_list[(int)VarRef.Tag.LiveCountry].tier3.Add(VarRef.Topic.SportsGolf);
...

        {
            ...
            tag_list[(int)VarRef.Tag.OccStudent].tier3.Add(VarRef.Topic.ElecHouse);
            ...
            tag_list[(int)VarRef.Tag.OccStudent].tier3.Add(VarRef.Topic.SportsGymnastics);
        }

        {
            tag_list[(int)VarRef.Tag.OccEmployed].tier2.Add(VarRef.Topic.CarsBudget);
            tag_list[(int)VarRef.Tag.OccEmployed].tier2.Add(VarRef.Topic.ElecHouse);
            ...
            tag_list[(int)VarRef.Tag.OccEmployed].tier3.Add(VarRef.Topic.FoodGourmet);
            tag_list[(int)VarRef.Tag.OccEmployed].tier3.Add(VarRef.Topic.FoodQuick);
            tag_list[(int)VarRef.Tag.OccEmployed].tier3.Add(VarRef.Topic.FoodCafe);
            tag_list[(int)VarRef.Tag.OccEmployed].tier3.Add(VarRef.Topic.SportsGolf);
            tag_list[(int)VarRef.Tag.OccEmployed].tier3.Add(VarRef.Topic.CarsHighend);
        }

        {
            tag_list[(int)VarRef.Tag.OccUnemployed].tier2.Add(VarRef.Topic.FoodQuick);
            ...
            tag_list[(int)VarRef.Tag.OccUnemployed].tier3.Add(VarRef.Topic.ElecPhone);
            tag_list[(int)VarRef.Tag.OccUnemployed].tier3.Add(VarRef.Topic.TravelBudget);
            tag_list[(int)VarRef.Tag.OccUnemployed].tier3.Add(VarRef.Topic.SportsGolf);
        }

        {
            ...
            tag_list[(int)VarRef.Tag.FamSingle].tier3.Add(VarRef.Topic.ClothesCostume);
            tag_list[(int)VarRef.Tag.FamSingle].tier3.Add(VarRef.Topic.SportsFootball);
            tag_list[(int)VarRef.Tag.FamSingle].tier3.Add(VarRef.Topic.FoodCafe);
        }

        {
            tag_list[(int)VarRef.Tag.FamInRelationship].tier2.Add(VarRef.Topic.TravelBudget);
            tag_list[(int)VarRef.Tag.FamInRelationship].tier2.Add(VarRef.Topic.FoodGourmet);

            tag_list[(int)VarRef.Tag.FamInRelationship].tier3.Add(VarRef.Topic.CarsBudget);
            tag_list[(int)VarRef.Tag.FamInRelationship].tier3.Add(VarRef.Topic.TravelCruise);
            tag_list[(int)VarRef.Tag.FamInRelationship].tier3.Add(VarRef.Topic.FoodCafe);
...

        {
            ...
            tag_list[(int)VarRef.Tag.FamHasKids].tier2.Add(VarRef.Topic.ElecGames);
            ...
            tag_list[(int)VarRef.Tag.FamHasKids].tier3.Add(VarRef.Topic.SportsFootball);
            tag_list[(int)VarRef.Tag.FamHasKids].tier3.Add(VarRef.Topic.SportsGymnastics);
        }
...

        {
            ...
            tag_list[(int)VarRef.Tag.SearchParty].tier3.Add(VarRef.Topic.ClothesWomen);
            tag_list[(int)VarRef.Tag.SearchParty].tier3.Add(VarRef.Topic.ClothesMen);
        }

        {
            tag_list[(int)VarRef.Tag.SearchOutdoor].tier1.Add(VarRef.Topic.SportsFootball);
            tag_list[(int)VarRef.Tag.SearchOutdoor].tier1.Add(VarRef.Topic.SportsGolf);

            tag_list[(int)VarRef.Tag.SearchOutdoor].tier3.Add(VarRef.Topic.TravelBudget);
        }

        {
            tag_list[(int)VarRef.Tag.SearchEatOut].tier1.Add(VarRef.Topic.FoodCafe);
            tag_list[(int)VarRef.Tag.SearchEatOut].tier1.Add(VarRef.Topic.FoodGourmet);

            tag_list[(int)VarRef.Tag.SearchEatOut].tier2.Add(VarRef.Topic.FoodQuick);
        }

        {
            ...
            tag_list[(int)VarRef.Tag.SearchVacation].tier3.Add(VarRef.Topic.ClothesWomen);
            tag_list[(int)VarRef.Tag.SearchVacation].tier3.Add(VarRef.Topic.ClothesMen);
        }

        {
            ...
            tag_list[(int)VarRef.Tag.SearchIndoor].tier2.Add(VarRef.Topic.FoodGourmet);

            tag_list[(int)VarRef.Tag.SearchIndoor].tier3.Add(VarRef.Topic.ElecHouse);
        }

        {
            ...
            tag_list[(int)VarRef.Tag.SearchBusiness].tier3.Add(VarRef.Topic.FoodCafe);
        }

        {
            tag_list[(int)VarRef.Tag.SearchVehicle].tier1.Add(VarRef.Topic.CarsHighend);
            tag_list[(int)VarRef.Tag.SearchVehicle].tier1.Add(VarRef.Topic.CarsParts);

            tag_list[(int)VarRef.Tag.SearchVehicle].tier2.Add(VarRef.Topic.CarsBudget);
        }

        {
            tag_list[(int)VarRef.Tag.FinPoor].tier1.Add(VarRef.Topic.FoodQuick);
            ...
            tag_list[(int)VarRef.Tag.FinPoor].tier3.Add(VarRef.Topic.FoodCafe);
            tag_list[(int)VarRef.Tag.FinPoor].tier3.Add(VarRef.Topic.TravelBudget);
        }

        {
            ...
            tag_list[(int)VarRef.Tag.FinMiddleClass].tier3.Add(VarRef.Topic.FoodQuick);
        }

        {
            ...
            tag_list[(int)VarRef.Tag.FinRich].tier2.Add(VarRef.Topic.SportsGolf);
        }
    }
}